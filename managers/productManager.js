...
exports.updateProduct = function (json, callback) {
    ...
    var isOk = manager.securityCheck(json);
    if (isOk) {
        console.log("updateProduct req in manager: " + JSON.stringify(json));
        if (json.productName !== undefined && json.productName !== null &&
                json.brand !== undefined && json.brand !== null &&
                json.model !== undefined && json.model !== null &&
            ...
            db.updateProduct(json, function (result) {
                if (result && result.success) {
                    ...
                    returnVal.message = "Error updating product";
                    callback(returnVal);
                }
            });
        } else {
...
exports.getProduct = function (id, clientId, callback) {
    ...
    if (idOk && clientIdOk) {
        db.getProduct(id, clientId, function (result) {
            if (result) {                
                callback(result);
            } else {
                callback({});
...
exports.deleteProduct = function (id, clientId, callback) {
    ...
    var clientIdOk = manager.securityCheck(clientId);
    if (idOk && clientIdOk) {
        db.deleteProduct(id, clientId, function (result) {
            if (result && result.success) {
                returnVal.success = result.success;
                callback(returnVal);
            } else {
